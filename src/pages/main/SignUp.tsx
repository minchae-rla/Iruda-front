...
``
  ...
  return (
    <div className="flex justify-center items-center flex-col bg-white space-y-4 h-screen">
      <div className="rounded-lg border-2 space-y-4 py-4">
        ...
        <form
          ...
          className="flex justify-center items-center flex-col space-y-6 w-[350px]"
        >
